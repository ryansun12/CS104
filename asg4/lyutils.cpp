...
astree* new_id(astree* t, astree* c1,astree* c2) {
   astree* new_t = new astree(TOK_TYPE_ID, t->lloc, "");
   return new_t->adopt(c1,c2);
}
//astree* new_fn(astree* t){
//   return new astree(TOK_FUNCTION, t->lloc, "");
//}
